        ...
        },
        {
          ...
          items: [
            { label: 'Overview', link: '/docs/integrations/' },
            {
              label: 'Frameworks',
              items: [
                { label: 'Strands (Python)', slug: 'docs/integrations/frameworks/strands' },
                { label: 'Strands (TypeScript)', slug: 'docs/integrations/frameworks/strands-typescript' },
            ...
            },
            {
              ...
              items: [
                ...
                { label: 'Google Vertex AI', slug: 'docs/integrations/providers/vertex-ai' },
              ],
            },
          ],
        },

...
│   ├── files/          # File storage (filesystem / S3)
│   └── topics/         # Pub/sub messaging (in-memory / Redis)
├── domain/
│   ├── pricing/        # Cost calculation
│   ├── providers/      # Provider connectors
│   ├── rules/          # Framework knowledge, interpreted from assets
│   ├── metrics/        # Metric datapoint identity

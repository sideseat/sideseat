...
| `OTEL_EXPORTER_OTLP_TIMEOUT` | Timeout in **seconds** (the TypeScript SDK reads the same variable in milliseconds, per each ecosystem's OpenTelemetry convention) | `30` |

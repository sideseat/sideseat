...
| `--otel-retention-max-age` | `SIDESEAT_OTEL_RETENTION_MAX_AGE_MINUTES` | `10080` | Max age in minutes |
| `--otel-retention-max-spans` | `SIDESEAT_OTEL_RETENTION_MAX_SPANS` | `1000000` | Max spans to retain |

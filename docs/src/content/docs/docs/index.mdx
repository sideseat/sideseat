...
SideSeat accepts standard OpenTelemetry traces. Run `npx sideseat`, point your exporter at `http://localhost:5388/otel/default/v1/traces`, and open [http://localhost:5388](http://localhost:5388).
...
<FrameworkDropdown label="Framework / Provider" items={[
     {
       ...
       group: "Frameworks",
       lang: "python",
       install: "pip install 'strands-agents[otel]' opentelemetry-instrumentation-botocore",

...
import { settings, SIDEBAR_STATE_KEY } from "@/lib/settings";
...
function SidebarProvider({
  ...
  const [_open, _setOpen] = React.useState(() => {
    // Load saved state from localStorage, fallback to defaultOpen
    const savedState = settings.get<boolean>(SIDEBAR_STATE_KEY);
  ...
  const setOpen = React.useCallback(
    (value: boolean | ((value: boolean) => boolean)) => {
      ...
      // Save the sidebar state to localStorage using our Settings class
      settings.set(SIDEBAR_STATE_KEY, openState);
    },
    [setOpenProp, open],
  );

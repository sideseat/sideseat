"""CLI argument parsing for Bedrock samples."""
...
from bedrock_sample.config import DEFAULT_MODEL, MODEL_ALIASES, SAMPLES
from bedrock_sample.runner import run_all_samples, run_sample
...
def create_parser() -> argparse.ArgumentParser:
    parser = argparse.ArgumentParser(
        prog="bedrock",
        description="Run Bedrock API samples with SideSeat instrumentation",
    )

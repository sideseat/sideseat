"""CLI argument parsing for CrewAI samples."""
...
from crewai_sample.config import DEFAULT_MODEL, MODEL_ALIASES, SAMPLES
from crewai_sample.runner import run_all_samples, run_sample
...
def create_parser() -> argparse.ArgumentParser:
    parser = argparse.ArgumentParser(
        prog="crewai",
        description="Run CrewAI agent samples with configurable telemetry and models",
    )

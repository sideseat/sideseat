"""CLI argument parsing for Google ADK samples."""
...
from adk_sample.config import DEFAULT_MODEL, MODEL_ALIASES, SAMPLES
from adk_sample.runner import run_all_samples, run_sample
...
def create_parser() -> argparse.ArgumentParser:
    parser = argparse.ArgumentParser(
        prog="adk",
        description="Run Google ADK agent samples with configurable telemetry and models",
    )

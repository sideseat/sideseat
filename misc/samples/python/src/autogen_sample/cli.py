"""CLI argument parsing for AutoGen samples."""
...
from autogen_sample.config import DEFAULT_MODEL, MODEL_ALIASES, SAMPLES
from autogen_sample.runner import run_all_samples, run_sample
...
def create_parser() -> argparse.ArgumentParser:
    parser = argparse.ArgumentParser(
        prog="autogen",
        description="Run AutoGen AI agent samples with configurable telemetry and models",
    )

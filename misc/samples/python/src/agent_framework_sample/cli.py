"""CLI argument parsing for Microsoft Agent Framework samples."""
...
from agent_framework_sample.config import DEFAULT_MODEL, MODEL_ALIASES, SAMPLES
from agent_framework_sample.runner import run_all_samples, run_sample
...
def create_parser() -> argparse.ArgumentParser:
    parser = argparse.ArgumentParser(
        ...
        description="Run Microsoft Agent Framework samples with configurable telemetry and models",
    )

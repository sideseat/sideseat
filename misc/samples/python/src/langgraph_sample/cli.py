"""CLI argument parsing for LangGraph samples."""
...
from langgraph_sample.config import DEFAULT_MODEL, MODEL_ALIASES, SAMPLES
from langgraph_sample.runner import run_all_samples, run_sample
...
def create_parser() -> argparse.ArgumentParser:
    parser = argparse.ArgumentParser(
        prog="langgraph",
        description="Run LangGraph AI agent samples with configurable telemetry and models",
    )

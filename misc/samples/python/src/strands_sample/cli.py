"""CLI argument parsing for strands samples."""
...
from strands_sample.config import DEFAULT_MODEL, MODEL_ALIASES, SAMPLES
from strands_sample.runner import run_all_samples, run_sample
...
def create_parser() -> argparse.ArgumentParser:
    parser = argparse.ArgumentParser(
        prog="strands",
        description="Run Strands AI agent samples with configurable telemetry and models",
    )
    ...
    parser.add_argument(
        "--sideseat",
        action="store_true",
        help="Use SideSeat SDK instead of StrandsTelemetry",
    )

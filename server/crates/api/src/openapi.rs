...
#[openapi(
    ...
    paths(
        ...
        projects::get_project_hold,
        projects::set_project_hold,
        projects::clear_project_hold,
        projects::get_project_storage,
        // Pricing
        ...
        // Metrics
        otel::metrics::list_metrics,
        otel::metrics::get_metric,
        otel::metrics::aggregate_metrics,
        otel::metrics::get_metric_filter_options,
        // Logs
        otel::logs::list_logs,
    ...
    components(schemas(
        ...
        projects::types::SetProjectHoldRequest,
        projects::types::ProjectHoldDto,
        projects::types::ProjectStorageUsageDto,
        // OTEL types

...
//!
//! See `docs/engineering/protocol-ws-v1/schema.json` and `codes.md` for the source of
//! truth.

use serde::{Deserialize, Serialize};

use sideseat_ports::registrations::{RegistrationKind, RegistrationManifest};
...
/// single WS frame. See `docs/engineering/protocol-ws-v1/chunking.md`.
#[derive(Debug, Clone, Deserialize)]

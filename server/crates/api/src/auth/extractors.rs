...
//! # use sideseat_api::auth::ProjectRead;
//! # use sideseat_api::types::ApiError;
//! # struct OtelApiState;
...
///
/// ```no_run
/// # use sideseat_api::auth::{ProjectAccess, Read};
/// # use sideseat_api::types::ApiError;
    ...
    Scope: ScopeLevel,
{
    ...
    async fn from_request_parts(parts: &mut Parts, _state: &S) -> Result<Self, Self::Rejection> {
        ...
        Ok(Self {
            project_id: params.project_id.into(),
            org_id,
            auth,
            _scope: PhantomData,
        })
...
///
/// ```no_run
/// # use sideseat_api::auth::OrgAdmin;
/// # use sideseat_api::types::ApiError;

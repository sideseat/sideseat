...
fn no_production_module_names_a_framework() {
    ...
    const EXEMPT: &[(&str, Allowed, &str)] = &[
        (
            "server/crates/domain/src/domain/traces/extract/framework_oracle.rs",
        ...
        (
            "server/crates/domain/src/domain/providers/catalog.rs",
        ...
        (
            "server/crates/domain/src/domain/providers/service.rs",
            Allowed::Only(&["azure-ai-foundry"]),

...
impl From<ChMessageSpanRow> for MessageSpanRow {
    fn from(row: ChMessageSpanRow) -> Self {
        Self {
            ...
            messages_json: row.messages.unwrap_or_default(),
            model: row.model,
            ...
            tool_definitions_json: row.tool_definitions.unwrap_or_default(),
            tool_names_json: row.tool_names.unwrap_or_default(),

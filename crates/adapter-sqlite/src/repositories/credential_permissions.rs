...
mod tests {
    use super::*;
    use crate::repositories::credentials::delete_credential;
    ...
    async fn create_credential(
        ...
        created_by: Option<&str>,
    ) -> Result<sideseat_ports::types::CredentialRow, SqliteError> {
        crate::repositories::credentials::create_credential(
            pool,
            id,
            org_id,
            provider_key,
    ...
    async fn create_credential_permission(
        ...
        super::create_credential_permission(
            pool,
            id,
            credential_id,
            org_id,

...
`run_sql` tool against examples/data/car_sales.csv. The graph and all three inner
...
# samples/ -> strands/ -> python/ -> examples/
DATA_PATH = (Path(__file__).resolve().parents[3] / "data" / "car_sales.csv").as_posix()
